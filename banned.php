            ...
            <div class="page-content-max-width" style="flex-direction: column;align-items: flex-start;">
                <div class="page-content-collider-item">
                   <div class="page-content-collider-content not-found">
						...
						<h3 class="page-content-collider-content-not-found-title">You are banned</h3>
						<p class="page-content-collider-content-not-found-text">You have been banned for <b>advertising</b>. Your ban will expire on April 30, 2023. Remember to follow the rules and refrain from behavior that will negatively affect the community.</a></p>
				   </div>
                </div>
            </div>
        </div>
