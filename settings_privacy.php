                    ...
                    <div class="page-content-collider-content">
                        <div class="page-content-collider-content-settings">
                            <div class="page-content-collider-content-settings-left-side">
                                <a href="/settings_privacy.php" class="page-content-collider-content-settings-left-side-item active">
                            ...
                            <div class="page-content-collider-content-settings-right-side">
                                ...
                                <div class="page-content-collider-content-settings-right-side-item">
                                    <div class="page-content-collider-content-settings-right-side-item-column">
                                        <h3 class="page-content-collider-content-settings-right-side-item-title">Allow Friends</h3>
                                        <p class="page-content-collider-content-settings-right-side-item-description">Books Allow you allow other people to send you a friend request?</p>
                                    </div>
                                    <div class="page-content-collider-settings-right-side-item-buttons">
                                        <button class="page-content-collider-settings-right-side-item-buttons-default-button fill active">Yes</button>
                                        <button class="page-content-collider-settings-right-side-item-buttons-default-button">No</button>
                                    </div>
                                </div>
                                <div class="page-content-collider-content-settings-right-side-item">
                                    <div class="page-content-collider-content-settings-right-side-item-column">
                                    ...
                                    <div class="page-content-collider-settings-right-side-item-buttons">
                                        <button class="page-content-collider-settings-right-side-item-buttons-default-button fill">Yes</button>
                                        <button class="page-content-collider-settings-right-side-item-buttons-default-button">No</button>
                                    </div>
                                </div>
                                <div class="page-content-collider-content-settings-right-side-item">
